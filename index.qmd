...
# Check modification time of _quarto.yml to invalidate cache when it changes
yml_time <- file.info("_quarto.yml")$mtime
print(yml_time)  # This line ensures Quarto detects changes in the file
```
